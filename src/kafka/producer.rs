...
pub struct KafkaProducer {
    producer: Arc<Mutex<Producer>>,  // Using Arc<Mutex<Producer>> for thread safety
    topic: String,
...
impl KafkaProducer {
    ...
    // Asynchronously add the payload to the buffer and flush if needed
    ...
    // Asynchronously flush the buffer by sending all messages with retries
    ...
    // Async retry logic using tokio's sleep instead of blocking thread sleep
...
// Manually implement Clone for safe sharing of the producer
